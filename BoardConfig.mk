...
# init takes very long to write to /dev/console so do not set it
BOARD_KERNEL_CMDLINE := androidboot.hardware=hammerhead user_debug=31 msm_watchdog_v2.enable=1
